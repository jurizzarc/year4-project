            ...
            <nav className="side-nav">
                <ul className="side-nav-list">
                    <li>
                        <Link
                            to="/dashboard"
                            className={splitLocation[1] === 'dashboard' ? 'activeRoute' : 'side-nav-link'}
                        >
                    ...
                    <li>
                        <Link
                            to="/settings"
                            className={splitLocation[1] === 'settings' ? 'activeRoute' : 'side-nav-link'}
                        >
                    ...
                    <li>
                        <Link
                            to="/help"
                            className={splitLocation[1] === 'help' ? 'activeRoute' : 'side-nav-link'}
                        >
