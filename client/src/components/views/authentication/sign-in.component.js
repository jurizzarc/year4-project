...
const SignIn = () => {
  ...
  const onFormSubmit = async (e) => {
    ...
    try {
      ...
      const loginRes = await axios.post(`${BASE_API_URL}/login`, currentUser);
      setUserData({
  ...
  return (
    <>
      ...
      <main className="authentication-form-container">
        <form className="authentication-form" onSubmit={onFormSubmit}>
          ...
          {errorSum && <Danger message={errorSum} ariaRole="Error Summary" />}
